...
function add_cart(){
	...
	if(isset($_GET['add_cart'])){
			...
			if(mysqli_num_rows($run_check)>0){
					echo "<script>alert('This product is alreadyin cart')</script>";
				...
				if($pro_label=="sale"){
					...
					$query = "INSERT INTO cart(p_id,ip_add,qty,size,p_price) VALUES('$p_id','$ip_add','$product_qty','$product_size','$product_price')";
