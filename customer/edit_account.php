...
$select_customer = "SELECT * FROM customers WHERE customer_email='$customer_session'";
...
<form method="post" action="" enctype="multipart/form-data"><!----form Begin------------->
...
if(isset($_POST['update'])){
	...
	if($run_customer){
		echo "<script>alert('Your account have been sucessfully edited.')</script>";
